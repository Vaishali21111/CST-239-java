...
public class User {
	...
	public void displayActions() {
		...
		System.out.println("6. Order products in inventory by name (ascending)");
		System.out.println("7. Order products in inventory by name (descending)");
		System.out.println("8. Order products in inventory by price (ascending)");
		System.out.println("9. Order products in inventory by price (descending)");
	}
	...
	public void interact() {
		while(true) {
			...
			case 6:
				orderInventoryByName(true);
				break;
				
			case 7:
				orderInventoryByName(false);
				break;
				
			case 8:
				orderInventoryByPrice(true);
				break;
				
			case 9:
				orderInventoryByPrice(false);
				break;
	...
	// Order products in inventory by name.
	public void orderInventoryByName(boolean ascending) {
		List<SalableProduct> orderedInventory = store.orderInventoryByName(ascending);
		System.out.println("Inventory ordered by name:");
	...
	// Order products in inventory by price.
	public void orderInventoryByPrice(boolean ascending) {
		List<SalableProduct> orderedInventory = store.orderInventoryByPrice(ascending);
		System.out.println("Inventory ordered by price:");
		for (SalableProduct product : orderedInventory) {
			System.out.println("Name: " + product.getName() + ", Price: " + product.getPrice() + ", Quantity Available: " + product.getQuantity());
		}
	}
